...
object Ejem1ManagerError extends App {
  ...
  val businessFunc3: TypeFunction3 = (elem: String) =>
    elem match {
  ...
  def doBusinessService(name: String): Try[EntityEj1] = {
    ...
    } yield (EntityEj1(elem1, elem2, elem3))).recoverWith {
